'''
https://github.com/Rayhane-mamah/Tacotron-2/blob/ab5cb08a931fc842d3892ebeb27c8b8734ddd4b8/datasets/audio.py
这份taco-audio代码，包含了mel转mag，mag转语音

用的是 np.linalg.pinv 求逆矩阵 的思路
...
def _mel_to_linear(mel_spectrogram, hparams):
    ...
    if _inv_mel_basis is None:
        _inv_mel_basis = np.linalg.pinv(_build_mel_basis(hparams))  # 直接求"伪逆矩阵"；效果不好
