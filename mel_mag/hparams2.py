...
hparams = tf.contrib.training.HParams(
    ...
    # The hparams arguments can be directly modified on this hparams2.py file instead of being specified on run if preferred!
    ...
    sample_rate=20000,  # 22050 Hz (corresponding to ljspeech dataset) (sox --i <filename>)
